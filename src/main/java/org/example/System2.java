                                    ...
                                    for (int p = 0; p < s2_charArray.length; p++) {
                                        for (int q = 0; q < s2_charArray.length; q++) {
                                            for (int r = 0; r < s2_charArray.length; r++) {
                                                String s2_combination = "" + s2_charArray[i] + s2_charArray[j]
                                                        + s2_charArray[k] + s2_charArray[l] + s2_charArray[m]
                                                        + s2_charArray[n] + s2_charArray[o] + s2_charArray[p]
                                                        + s2_charArray[q] + s2_charArray[r];
